...
function getDefaultConfig() {
  ...
  const config2 = {
    ...
    "deploy:dodo_test:merkle_airdrop_base_mainnet":
      "graph codegen subgraphs/merkle-airdrop/merkle_base_mainnet.yaml --output-dir ./src/types/merkle/  && graph deploy --ipfs http://127.0.0.1:5001 --node http://127.0.0.1:8020 dodoex/merkle_airdrop_base_mainnet subgraphs/merkle-airdrop/merkle_base_mainnet.yaml",
  };
  return config2;
}
