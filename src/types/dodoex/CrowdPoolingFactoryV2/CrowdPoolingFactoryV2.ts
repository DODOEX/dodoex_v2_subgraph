...
export class RemoveCP extends ethereum.Event {
  get params(): RemoveCP__Params {
    return new RemoveCP__Params(this);
  }
}

export class RemoveCP__Params {
  _event: RemoveCP;

  constructor(event: RemoveCP) {
    this._event = event;
  }
...
export class CrowdPoolingFactoryV2__getCrowdPoolingBidirectionResult {
...
export class CrowdPoolingFactoryV2 extends ethereum.SmartContract {
  static bind(address: Address): CrowdPoolingFactoryV2 {
    return new CrowdPoolingFactoryV2("CrowdPoolingFactoryV2", address);
  }
  ...
  getCrowdPoolingBidirection(
    token0: Address,
    token1: Address
  ): CrowdPoolingFactoryV2__getCrowdPoolingBidirectionResult {
    let result = super.call(
      "getCrowdPoolingBidirection",
    ...
    return new CrowdPoolingFactoryV2__getCrowdPoolingBidirectionResult(
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new CrowdPoolingFactoryV2__getCrowdPoolingBidirectionResult(
...
export class UpdateDefaultMaintainerCall extends ethereum.Call {
  get inputs(): UpdateDefaultMaintainerCall__Inputs {
    return new UpdateDefaultMaintainerCall__Inputs(this);
  }

  get outputs(): UpdateDefaultMaintainerCall__Outputs {
    return new UpdateDefaultMaintainerCall__Outputs(this);
  }
}

export class UpdateDefaultMaintainerCall__Inputs {
  _call: UpdateDefaultMaintainerCall;

  constructor(call: UpdateDefaultMaintainerCall) {
    this._call = call;
  }

  get _newMaintainer(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class UpdateDefaultMaintainerCall__Outputs {
  _call: UpdateDefaultMaintainerCall;
