...
export class ClaimBaseToken extends ethereum.Event {
  get params(): ClaimBaseToken__Params {
    return new ClaimBaseToken__Params(this);
  }
}

export class ClaimBaseToken__Params {
  _event: ClaimBaseToken;

  constructor(event: ClaimBaseToken) {
    this._event = event;
  }
...
export class ClaimQuoteToken extends ethereum.Event {
  get params(): ClaimQuoteToken__Params {
    return new ClaimQuoteToken__Params(this);
  }
}

export class ClaimQuoteToken__Params {
  _event: ClaimQuoteToken;

  constructor(event: ClaimQuoteToken) {
    this._event = event;
  }
...
export class CPV2__getSettleResultResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class CPV2 extends ethereum.SmartContract {
  static bind(address: Address): CPV2 {
    return new CPV2("CPV2", address);
  }
  ...
  _CLAIMED_BASE_TOKEN_(param0: Address): BigInt {
    let result = super.call(
      "_CLAIMED_BASE_TOKEN_",
      "_CLAIMED_BASE_TOKEN_(address):(uint256)",
  ...
  try__CLAIMED_BASE_TOKEN_(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_CLAIMED_BASE_TOKEN_",
      "_CLAIMED_BASE_TOKEN_(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  _CLAIMED_QUOTE_(param0: Address): boolean {
    let result = super.call(
      "_CLAIMED_QUOTE_",
      "_CLAIMED_QUOTE_(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try__CLAIMED_QUOTE_(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "_CLAIMED_QUOTE_",
      "_CLAIMED_QUOTE_(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
  ...
  _FORCE_STOP_(): boolean {
    let result = super.call("_FORCE_STOP_", "_FORCE_STOP_():(bool)", []);

    return result[0].toBoolean();
  }

  try__FORCE_STOP_(): ethereum.CallResult<boolean> {
    let result = super.tryCall("_FORCE_STOP_", "_FORCE_STOP_():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  _IS_OVERCAP_STOP(): boolean {
    let result = super.call(
      "_IS_OVERCAP_STOP",
      "_IS_OVERCAP_STOP():(bool)",
      []
    );
  ...
  try__IS_OVERCAP_STOP(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "_IS_OVERCAP_STOP",
      "_IS_OVERCAP_STOP():(bool)",
      []
  ...
  _POOL_FEE_RATE_(): BigInt {
    let result = super.call(
      "_POOL_FEE_RATE_",
      "_POOL_FEE_RATE_():(uint256)",
      []
    );
  ...
  try__POOL_FEE_RATE_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_POOL_FEE_RATE_",
      "_POOL_FEE_RATE_():(uint256)",
      []
  ...
  _TOKEN_CLAIM_DURATION_(): BigInt {
    let result = super.call(
      "_TOKEN_CLAIM_DURATION_",
      "_TOKEN_CLAIM_DURATION_():(uint256)",
      []
    );
  ...
  try__TOKEN_CLAIM_DURATION_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_TOKEN_CLAIM_DURATION_",
      "_TOKEN_CLAIM_DURATION_():(uint256)",
      []
  ...
  _TOKEN_CLIFF_RATE_(): BigInt {
    let result = super.call(
      "_TOKEN_CLIFF_RATE_",
      "_TOKEN_CLIFF_RATE_():(uint256)",
      []
    );
  ...
  try__TOKEN_CLIFF_RATE_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_TOKEN_CLIFF_RATE_",
      "_TOKEN_CLIFF_RATE_():(uint256)",
      []
  ...
  _TOKEN_VESTING_DURATION_(): BigInt {
    let result = super.call(
      "_TOKEN_VESTING_DURATION_",
      "_TOKEN_VESTING_DURATION_():(uint256)",
      []
    );
  ...
  try__TOKEN_VESTING_DURATION_(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_TOKEN_VESTING_DURATION_",
      "_TOKEN_VESTING_DURATION_():(uint256)",
      []
  ...
  getClaimableBaseToken(user: Address): BigInt {
    let result = super.call(
      "getClaimableBaseToken",
      "getClaimableBaseToken(address):(uint256)",
  ...
  try_getClaimableBaseToken(user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getClaimableBaseToken",
      "getClaimableBaseToken(address):(uint256)",
      [ethereum.Value.fromAddress(user)]
  ...
  getRemainingBaseTokenRatio(timestamp: BigInt): BigInt {
    let result = super.call(
      "getRemainingBaseTokenRatio",
      "getRemainingBaseTokenRatio(uint256):(uint256)",
  ...
  try_getRemainingBaseTokenRatio(
    timestamp: BigInt
  ...
  getSettleResult(): CPV2__getSettleResultResult {
    let result = super.call(
      "getSettleResult",
    ...
    return new CPV2__getSettleResultResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getSettleResult(): ethereum.CallResult<CPV2__getSettleResultResult> {
    let result = super.tryCall(
      "getSettleResult",
      "getSettleResult():(uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new CPV2__getSettleResultResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class ForceStopCall extends ethereum.Call {
  get inputs(): ForceStopCall__Inputs {
    return new ForceStopCall__Inputs(this);
  }

  get outputs(): ForceStopCall__Outputs {
    return new ForceStopCall__Outputs(this);
  }
}

export class ForceStopCall__Inputs {
  _call: ForceStopCall;

  constructor(call: ForceStopCall) {
    this._call = call;
  }
}

export class ForceStopCall__Outputs {
  _call: ForceStopCall;
