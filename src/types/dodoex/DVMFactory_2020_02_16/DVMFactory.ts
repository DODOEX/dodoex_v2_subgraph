...
export class DVMFactory__getDODOPoolBidirectionResult {
...
export class DVMFactory extends ethereum.SmartContract {
  ...
  createDODOVendingMachine(
    ...
    let result = super.call(
      "createDODOVendingMachine",
      "createDODOVendingMachine(address,address,uint256,uint256,uint256,bool):(address)",
      [
  ...
  getDODOPoolBidirection(
    token0: Address,
    token1: Address
  ): DVMFactory__getDODOPoolBidirectionResult {
    let result = super.call(
      "getDODOPoolBidirection",
    ...
    return new DVMFactory__getDODOPoolBidirectionResult(
  ...
  try_getDODOPoolBidirection(
    token0: Address,
    token1: Address
  ): ethereum.CallResult<DVMFactory__getDODOPoolBidirectionResult> {
    let result = super.tryCall(
      "getDODOPoolBidirection",
      "getDODOPoolBidirection(address,address):(address[],address[])",
      [ethereum.Value.fromAddress(token0), ethereum.Value.fromAddress(token1)]
    ...
    return ethereum.CallResult.fromValue(
      new DVMFactory__getDODOPoolBidirectionResult(
