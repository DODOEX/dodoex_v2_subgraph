...
export class UpCrowdPoolingFactory__getCrowdPoolingBidirectionResult {
...
export class UpCrowdPoolingFactory extends ethereum.SmartContract {
  static bind(address: Address): UpCrowdPoolingFactory {
    return new UpCrowdPoolingFactory("UpCrowdPoolingFactory", address);
  }
  ...
  getCrowdPoolingBidirection(
    token0: Address,
    token1: Address
  ): UpCrowdPoolingFactory__getCrowdPoolingBidirectionResult {
    let result = super.call(
      "getCrowdPoolingBidirection",
    ...
    return new UpCrowdPoolingFactory__getCrowdPoolingBidirectionResult(
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new UpCrowdPoolingFactory__getCrowdPoolingBidirectionResult(
