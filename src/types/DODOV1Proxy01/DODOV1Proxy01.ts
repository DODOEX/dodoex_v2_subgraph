...
export class DODOV1Proxy01 extends ethereum.SmartContract {
  static bind(address: Address): DODOV1Proxy01 {
    return new DODOV1Proxy01("DODOV1Proxy01", address);
  }
  ...
  _GAS_DODO_MAX_RETURN_(): i32 {
    let result = super.call(
      "_GAS_DODO_MAX_RETURN_",
      "_GAS_DODO_MAX_RETURN_():(uint8)",
      []
    );
  ...
  try__GAS_DODO_MAX_RETURN_(): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "_GAS_DODO_MAX_RETURN_",
      "_GAS_DODO_MAX_RETURN_():(uint8)",
      []
  ...
  _GAS_EXTERNAL_RETURN_(): i32 {
    let result = super.call(
      "_GAS_EXTERNAL_RETURN_",
      "_GAS_EXTERNAL_RETURN_():(uint8)",
      []
    );
  ...
  try__GAS_EXTERNAL_RETURN_(): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "_GAS_EXTERNAL_RETURN_",
      "_GAS_EXTERNAL_RETURN_():(uint8)",
      []
...
export class UpdateGasReturnCall__Inputs {
  ...
  get newDodoGasReturn(): i32 {
    return this._call.inputValues[0].value.toI32();
  }

  get newExternalGasReturn(): i32 {
