...
export const DODOZooID = "dodoex-v2-berachain";
export const CHAIN_BASE_COIN_SYMBOL = "ETH";
export const CHAIN_BASE_COIN_NAME = "ethereum";
export const DIP3_TIMESTAMP = 1624442400;

export const SMART_ROUTE_ADDRESSES: string[] = ["0xfcd8EF54A4dA96dE6B2DDF67C6265C7405a3A9c6"];
...
export const CLASSIC_FACTORY_ADDRESS = "0xc6F5e5Ff8AbBe6A94A879A1E378c101E2A6bb9e6";
export const CROWDPOOLING_FACTORY_V2: string[] = ["0xc6F5e5Ff8AbBe6A94A879A1E378c101E2A6bb9e6"];

export const DVM_FACTORY_DEPLOY_BLOCK = 859765;
export const DPP_FACTORY_DEPLOY_BLOCK = 859765;
