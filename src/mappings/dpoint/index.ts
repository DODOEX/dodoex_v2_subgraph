...
import { Claim as ClaimEvent, LockedTokenVault } from "../../types/dpoint/templates/LockedTokenVault/LockedTokenVault";
...
export function handleClaim(event: ClaimEvent): void {
  ...
  let remainingRatio = lockedTokenVault.try_getRemainingRatio(event.block.timestamp);
  if (remainingRatio.reverted) {
    log.info("lockedTokenVault.try_getRemainingRatio reverted: {}", [entity.id]);
  }
  entity.remainingRatio = remainingRatio.value;
