...
import { ERC20 } from "../../../types/amm-v3/Factory/ERC20";
import { Pool as PoolABI } from "../../../types/amm-v3/Factory/Pool";
import { Pool, Token } from "../../../types/amm-v3/schema";
...
export function populateEmptyPools(
  ...
  for (let i = 0; i < length; ++i) {
    ...
    if (token0 && token1) {
      ...
      const tvlToken0Raw = token0Contract.balanceOf(
      ...
      const tvlToken1Raw = token1Contract.balanceOf(
        Address.fromString(pool.id)
      );
