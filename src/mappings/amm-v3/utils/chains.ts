...
export class SubgraphConfig {
  // deployment address
  // e.g. https://docs.amm.org/contracts/v3/reference/deployments/ethereum-deployments
...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == ARBITRUM_ONE_NETWORK_NAME) {
    ...
    return {
      ...
      stablecoinWrappedNativePoolAddress:
        "0x4c36388be6f416a29c8d8eee81c771ce6be14b18", // WETH-USDbC 0.05% pool
      stablecoinIsToken0: false,
    ...
    return {
      ...
      stablecoinWrappedNativePoolAddress:
        "0x3e3dd517fec2e70eddba2a626422a4ba286e8c38", // USDC.e/WETH 0.05% pool
      stablecoinIsToken0: true,
    ...
    return {
      ...
      stablecoinWrappedNativePoolAddress:
        "0xbc59f8f3b275aa56a90d13bae7cce5e6e11a3b17", // WETH/USDzC 3% pool
      stablecoinIsToken0: false,
      wrappedNativeAddress: "0x4200000000000000000000000000000000000006", // WETH
      minimumNativeLocked: BigDecimal.fromString("1"),
      stablecoinAddresses: [
    ...
    return {
      ...
      stablecoinWrappedNativePoolAddress:
        "0x5f835420502a7702de50cd0e78d8aa3608b2137e", // WETH/USDC.e 0.05% pool
      stablecoinIsToken0: false,
      wrappedNativeAddress: "0x4200000000000000000000000000000000000006", // WETH
      minimumNativeLocked: BigDecimal.fromString("1"),
      stablecoinAddresses: [
    ...
    return {
      ...
      stablecoinWrappedNativePoolAddress:
        "0x6418eec70f50913ff0d756b48d32ce7c02b47c47", // USDC/WETH 1% pool
      stablecoinIsToken0: true,
