...
export const SMART_ROUTE_ADDRESSES: string[] = ["0x55793c2c8a796cce00ef2d1a86cca2e0399bf285"];
...
export const CROWDPOOLING_FACTORY_V2: string[]=["0x392b2ae9ab6161591582c4724ca9a89c0cc1cab6"];
