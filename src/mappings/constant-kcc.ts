...
export const DODOZooID = "dodoex-v2-kcc";
export const CHAIN_BASE_COIN_SYMBOL = "KCS";
export const CHAIN_BASE_COIN_NAME = "kcs";
...
export const DVM_FACTORY_ADDRESS = "0x31ac053c31a77055b2ae2d3899091c0a9c19ce3a";
export const DPP_FACTORY_ADDRESS = "0x4632e6ebd4a01ebf54739a9d71a62cedb29e9183";
...
export const CROWDPOOLING_FACTORY_V2: string[] = [
  "0xae1e7e4c5743321d2a8ceed179264998a56cf1d9",
];
 ...
 * usd pricing
 */
export const WRAPPED_BASE_COIN = "0x4446fc4eb47f2f6586f9faab68b3498f86c07521";
//pricing supported stable coins
export const STABLE_ONE_ADDRESS = "0x0039f574ee5cc39bdd162e9a88e3eb1f111baf48"; //usdt
export const STABLE_TWO_ADDRESS = "0x980a5afef3d17ad98635f6c5aebcbaeded3c3430"; //usdc
//stable coins pairs
