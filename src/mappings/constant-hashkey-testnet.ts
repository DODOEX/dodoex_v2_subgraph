...
export const DODOZooID = "dodoex-v2-hashkey-testnet";
...
export const DVM_FACTORY_ADDRESS = "0x4c639e4d0bfeC3D0766AAA0500Ae7e91418505Bf";
...
export const DVM_FACTORY_DEPLOY_BLOCK = 1632368;
export const DPP_FACTORY_DEPLOY_BLOCK = 1632368;
